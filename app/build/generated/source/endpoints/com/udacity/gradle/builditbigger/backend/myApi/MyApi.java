...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetJokes getJokes(java.lang.Integer numOfJokes) throws java.io.IOException {
    GetJokes result = new GetJokes(numOfJokes);
    initialize(result);
    return result;
  }

  public class GetJokes extends MyApiRequest<com.udacity.gradle.builditbigger.backend.myApi.model.Joke> {

    private static final String REST_PATH = "joke/{numOfJokes}";
     ...
     * @since 1.13
     */
    protected GetJokes(java.lang.Integer numOfJokes) {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.gradle.builditbigger.backend.myApi.model.Joke.class);
      this.numOfJokes = com.google.api.client.util.Preconditions.checkNotNull(numOfJokes, "Required parameter numOfJokes must be specified.");
    }
    ...
    public GetJokes setNumOfJokes(java.lang.Integer numOfJokes) {
